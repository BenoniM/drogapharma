...
const navLinks: NavItem[] = [
  ...
  { label: "About", path: "/about" },
  {
    ...
    mega: true,
    children: [
      { label: "Medical", path: "/products?category=Medical", description: "General medical supplies" },
      { label: "Medical Devices", path: "/products?category=Medical+Devices", description: "Advanced devices & monitoring" },
      { label: "Laboratory", path: "/products?category=Laboratory", description: "Diagnostic & lab equipment" },
      { label: "Medical Equipment", path: "/products?category=Medical+Equipment", description: "Specialised medical infrastructure" },
      { label: "Orthopedics & Surgical", path: "/products?category=Orthopedics+and+Surgical+Instrument", description: "Precision surgical & orthopaedic" },
    ],
  },
